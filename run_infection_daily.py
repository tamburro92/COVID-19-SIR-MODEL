...
def main():
    ...
    (a, c, d), _ = opt.curve_fit(logistic_function_pdf, x, delta_infection.values, p0=[173084, 0.13, mean_est])
    print(a, c, d)
    ...
    (amplitude, mu, std), _ = opt.curve_fit(gaussian_function_pdf, x, delta_infection.values, p0=[max(delta_infection.values), mean_est, sigma_est])
    print(amplitude, mu, std)
